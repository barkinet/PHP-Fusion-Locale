...
Tu sau altcineva ai(a) solicitat o parola noua pentru accesarea contului tau la ".$settings['sitename'].".\n
Pentru schimbarea parolei, te rog apasa pe urmatoarea legatura:\n
[NEW_PASS_LINK]\n
Cu respect,
".$settings['siteusername'];
$locale['411'] = "Salut, [USER_NAME],\n
Noua ta parola de acces pentru contul la ".$settings['sitename']." este:\n
[NEW_PASS]\n
Cu respect,
".$settings['siteusername'];
