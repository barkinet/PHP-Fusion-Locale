...
// Contact Form
$locale['400'] = "Kontakt";
$locale['401'] = "Det finns tre sätt att kontakta mig, du kan skicka e-post direkt på ".hide_email($settings['siteemail']).". Om du är registrerad användare kan du skicka ett 
<a href='messages.php?msg_send=1'>PM</a>. Alternativt kan du fylla i formuläret på den här sidan så skickas ditt meddelande till mig via e-post.";
$locale['402'] = "Namn:";
